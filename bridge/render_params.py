...
# render/context.py:qrcode.QRCode.version
QRCODE_VERSION = 1
# render/context.py:qrcode.QRCode.error_correction
QRCODE_ERROR_CORRECTION = 1
# render/context.py:qrcode.QRCode.box_size
QRCODE_BOX_SIZE = 10
# render/context.py:qrcode.QRCode.border
QRCODE_BORDER = 1
